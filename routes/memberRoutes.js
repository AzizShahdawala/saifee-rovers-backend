...
import { deleteMember, enrollMemberFace, exportMembers, getMember, listMembers, registerMember, updateMember } from "../controllers/memberController.js";

const router = express.Router();
router.get("/", asyncHandler(listMembers));
router.get("/export", requireAuth, requireRole("admin"), asyncHandler(exportMembers));
